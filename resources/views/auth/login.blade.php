    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 border border-gray-100 sm:px-10">
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <button type="submit" class="w-full flex justify-center py-4 px-4 border border-transparent text-[11px] uppercase tracking-[0.2em] font-bold text-white bg-black hover:bg-gray-800 transition-all">
                    Sign In
                </button>
            </form>
            ...
            <div class="mt-6 text-center">
                <p class="text-[10px] uppercase tracking-widest text-gray-400">
                    Don't have an account? <a href="{{ route('register') }}" class="text-black font-bold border-b border-black pb-1 ml-1">Register here</a>
                </p>
            </div>
        </div>
    </div>
